...
public class MontadorDeMelodias {
	...
	private void initialize() {
		...
		TabelaNotas.setModel(new DefaultTableModel(new Object[][] {},new String[] { "Numero", "Duracao", "Amplitude", "Frequencia", "Fase" }){
		...
		HarmonicoSpinner.setModel(new SpinnerNumberModel(4,
				0, null, 1));
	...
	public void listenerAdd() {
		...
		Double amp = (double) (Integer) AmplitudeSpinner.getValue();
		Double freq = (Double) FrequenciaSpinner.getValue();
		Double fase = (double) (Integer) FaseSpinner.getValue();
